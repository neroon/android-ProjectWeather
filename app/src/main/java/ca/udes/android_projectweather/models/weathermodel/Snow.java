...
/**
 * A data snow object contains various properties, each representing the average (unless otherwise
...
public class Snow implements Serializable {
    ...
    @Nullable
    @SerializedName(ModelConstants.FIELD_3H)
    private Double mSnow;

    /**
     * The volume of snow for the last 3 hours (optional).
     *
     * @return      mSnow
     */
    @Nullable
