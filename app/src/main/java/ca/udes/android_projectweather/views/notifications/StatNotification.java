package ca.udes.android_projectweather.views.notifications;
...
public class StatNotification {
    ...
    public static void notify(final Context context,
                              final String cityName, final String cityCountry, final String cityTemp,
                              final int number) {
        ...
        final String tickerName = cityName + " " + cityCountry;
        final String tickerTemp = cityTemp;
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setContentTitle(tickerName)
                .setContentText(tickerTemp)
